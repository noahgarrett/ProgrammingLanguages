...
var definitions = map[Opcode]*Definition{
	...
	OpIndex:         {"OpIndex", []int{}},
	OpCall:          {"OpCall", []int{1}}, // Operand for the number of arguments for the given function
...
// Makes a bytecode instruction based on the OpCode and its operands
...
// Counter function to make, decompiles byte code
